...
from app.utils.helpers import get_client_name, get_case_type
...
def get_client_recommendations_full(client, cases, payments, related_files, recent_accesses, 
...
def client_detail(client_id):
    ...
    try:
        ...
        recommendations = get_client_recommendations_full(
            client, cases, payments, related_files, recent_accesses, 
            total_paid, total_pending, total_overdue
        )
