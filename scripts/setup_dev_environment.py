...
def main():
    ...
    parser.add_argument('--client-count', type=int, default=50, 
                       help='Number of clients to generate (default: 50)')
    parser.add_argument('--skip-schema', action='store_true', 
                       help='Skip database schema setup (use existing schema)')
    parser.add_argument('--skip-data', action='store_true', 
                       help='Skip dummy data generation')
    parser.add_argument('--skip-indexes', action='store_true', 
                       help='Skip performance index creation')
    parser.add_argument('--host', default='localhost', 
                       help='Database host (default: localhost)')
    parser.add_argument('--port', type=int, default=5432, 
                       help='Database port (default: 5432)')
    parser.add_argument('--database', default='legal_case_manager', 
                       help='Database name (default: legal_case_manager)')
